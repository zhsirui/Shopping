...
SECRET_KEY = ')%iibg^f=6)r3easgvpb=a@9&n$uo72z7=13ta6#%$dwzgzs_o'
...
FDFS_BASE_URL = 'http://192.168.44.128:8888/'
...
CRONJOBS = [
    # 每5分钟执行一次生成主页静态文件
    ('*/5 * * * *', 'contents.crons.generate_static_index_html', '>> /home/python/PycharmProjects/Shopping/meiduo_mall/logs/crontab.log')
]
